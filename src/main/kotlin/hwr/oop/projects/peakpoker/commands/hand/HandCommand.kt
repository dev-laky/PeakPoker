...
class HandCommand : CliktCommand(name = "hand") {
  ...
  override fun run() {
    ...
    val pokerPlayer = PokerPlayer(name = playerName!!, chips = 100)
    val pokerGame = hwr.oop.projects.peakpoker.core.game.PokerGame(
      smallBlindAmount = 10,
      bigBlindAmount = 20,
