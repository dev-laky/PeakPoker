...
fun compareOnePair(
  ...
  val kickers1 = v1.filter { it != pair1 }
    .take(3)    // take the next three highest -> Hand has only 5 Cards
...
fun compareStraight(
  ...
  val straight1 =
    highestStraightValue(ranks1)  // returns 5 to 14 or null -> See helper function @top
